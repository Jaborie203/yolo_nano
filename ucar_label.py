...
image_ids = open('data/Ucar_data_0308/obj3/train_.txt').read().strip().split()
list_file = open('data/Ucar_data_0308/obj3/train.txt', 'w')
for image_id in image_ids:
    list_file.write('data/Ucar_data_0308/obj3/images/{}\n'.format(image_id))
